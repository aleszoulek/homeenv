...
if has("gui_running")
    ...
    " exec "hi StatusLine     cterm=BOLD   ctermfg=" . <SID>X(88) . " ctermbg=" . <SID>X(85)
    exec "hi StatusLine     cterm=NONE   ctermfg=" . <SID>X(16) . " ctermbg=" . <SID>X(77)
    exec "hi StatusLineNC   cterm=NONE   ctermfg=" . <SID>X(77) . " ctermbg=" . <SID>X(81)
    exec "hi VertSplit      cterm=NONE   ctermfg=" . <SID>X(85) . " ctermbg=" . <SID>X(81)
    ...
    if v:version >= 700
        ...
        "exec "hi MatchParen     cterm=BOLD ctermbg=" . <SID>X(69) . "ctermfg=" . <SID>X(25)
        exec "hi MatchParen     cterm=BOLD ctermbg=" . <SID>X(39) . "ctermfg=" . <SID>X(25)
    endif
endif
